...
with st.expander('# Chat with InstantPixel.AI'):
    ...
    if prompt := st.chat_input('Your message here...'):
        ...
        Greet the user, but always answer straight to the point and concisely.
        
        # Example: 
        User:  I want a very short prompt for an image generation task for the following scenario: A camel in front of a pyramid
        Answer: A camel standing in front of the Great Pyramid of Giza
